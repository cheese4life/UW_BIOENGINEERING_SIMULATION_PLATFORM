 ...
 *           various operations such as Initialization, Homing and moving a DMCM.
 */
class DMCM : public Product
{
public:
    /*!
     ...
     *
     */
    DMCM( const std::string& productName, imp::IAxisDevice& axis );
    ...
    /*!
     *   @brief Home the axis to the encoder index flag.

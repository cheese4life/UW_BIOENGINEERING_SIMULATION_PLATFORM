/*!
*  @copyright The copyright to the computer program(s) herein is the property of
*             Dover Motion, Inc. This file is subject to the terms and
*             conditions found in the 'DoverLicense.txt' file included with this
*             source code package.
*
*  @file      LUNAFive.h
*  @author    Unknown - source is http://lua-users.org/wiki/LunaFive
*  @date      2016
*/
...
public:
    ...
    */
    ...
    static void Register( lua_State* L, const char* namespac = NULL )
    {
        ...
        lua_pushstring( L,
                        "__eq" );   // To be able to compare two Luna objects (not natively possible with full userdata)
        ...
        for ( int i = 0; T::properties[i].name; i++ )             // Register some properties in it
        {
            ...
            lua_pushnumber( L,
                            i );                                // And a number indexing which property it is
            lua_settable( L, metatable );
        }
    ...
    */
    static int property_getter( lua_State* L )
    {
        ...
        {
            auto _index = lround( lua_tonumber( L, -1 ));
    ...
    */
    ...
    {
        auto i = lround(lua_tonumber( L, lua_upvalueindex( 1 ) ));
    ...
    */
    ...
    static int to_string( lua_State* L )
    {
        ...
        if ( obj )
        {
            lua_pushfstring( L, "%s (%p)", T::className, static_cast<void* >(*obj) );
        }
        else
        {

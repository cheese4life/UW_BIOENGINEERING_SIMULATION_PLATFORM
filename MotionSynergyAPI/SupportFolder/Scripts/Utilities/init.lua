...
--- Checks if two positions are within a certain tolerance.
-- @param pos1 The first position.
-- @param pos2 The second position.
-- @param samePosTolerance The allowable tolerance in current units (default is 0.005).
-- @return true if the two positions are within the tolerance, false otherwise.
function Utilities.IsSamePos(pos1, pos2, samePosTolerance)
    samePosTolerance = samePosTolerance or 0.005
    return math.abs(pos1 - pos2) < samePosTolerance
end
